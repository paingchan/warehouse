...
$(".dropify").dropify({
  messages: {
    default: "Click to Upload Picture/Logo",
...
document
  ...
  .addEventListener("click", function () {
    ...
    $html =
      ...
      '<td class="text-right amount"><span class="editable-amount"><span class="currency">$</span> <span class="amount">0.01  </span></td>' +
...
selectableDropdown(
  document.querySelectorAll(".invoice-tax-select .dropdown-item"),
  getTaxValue
);
selectableDropdown(
  document.querySelectorAll(".invoice-discount-select .dropdown-item"),
  getDiscountValue
);
